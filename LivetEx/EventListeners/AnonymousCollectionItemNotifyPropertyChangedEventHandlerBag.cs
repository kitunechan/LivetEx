...
namespace LivetEx.EventListeners {
	...
	internal class AnonymousCollectionItemNotifyPropertyChangedEventHandlerBag : IEnumerable<KeyValuePair<string, List<PropertyChangedEventHandler>>> {
		...
		private WeakReference<ICollectionItemNotifyPropertyChanged> _source;
		...
		internal AnonymousCollectionItemNotifyPropertyChangedEventHandlerBag( ICollectionItemNotifyPropertyChanged source ) {
			if( source == null ) throw new ArgumentNullException( "source" );

			_source = new WeakReference<ICollectionItemNotifyPropertyChanged>( source );
		}

		internal AnonymousCollectionItemNotifyPropertyChangedEventHandlerBag( ICollectionItemNotifyPropertyChanged source, PropertyChangedEventHandler handler )
			: this( source ) {
		...
		internal void ExecuteHandler( PropertyChangedEventArgs e ) {
			ICollectionItemNotifyPropertyChanged sourceResult;
