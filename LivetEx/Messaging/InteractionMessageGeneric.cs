...
namespace LivetEx.Messaging {
	...
	public abstract class InteractionMessageOneParameter : InteractionMessage {
		public InteractionMessageOneParameter( string messageKey )
			: base( messageKey ) {
		}


		public InteractionMessageOneParameter( string messageKey, object value )
			: base( messageKey ) {
			Value = value;
		}
	...
	public class InteractionMessage<T>: InteractionMessageOneParameter {
		...
		public InteractionMessage( string messageKey, T value )
			: base( messageKey ) {
			Value = value;
		}
		...
		protected override Freezable CreateInstanceCore() {
			return new InteractionMessage<T>( MessageKey, Value );
		}
	}
}
